...
// traduit l'alphabet en morse en prennant un paramètre pour le mode de traduction (0 morse écrit)
...
{
    /*
    Penser à la gestion des majuscules
    Penser à la gestion des chiffres
